...
const LIMITS = {
  ...
  rayLength: [0.3, 2.5, 'starburst length'], rayCount: [6, 28, 'starburst rays'], smokeScale: [0.4, 3, 'smoke marble size'], floodRate: [0, 40, 'skull flood rate (/min)'], crownStyle: [0, 1, 'crown: 0 flores 1 corona'], crownPeaks: [3, 7, 'crown points'],
  ...
  textOn: [0, 1, 'show text'], musicOn: [0, 1, 'sound on (music, gritos, sfx)'], autoEvents: [0, 1, 'random events'], voiceOn: [0, 1, 'voice control'], beatSync: [0, 1, 'sync to the beat'], hudOn: [0, 1, 'fps monitor'], skullOnTop: [0, 1, 'skull always on top'], skullBreathe: [0, 1, 'skull breathing'], flowerCrown: [0, 1, 'flower crown'], crownBlooms: [3, 14, 'flower crown blooms'],
};
