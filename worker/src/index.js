...
const LIMITS = {
  ...
  rayLength: [0.3, 2.5, 'starburst length'], rayCount: [6, 28, 'starburst rays'], smokeScale: [0.4, 3, 'smoke marble size'], floodRate: [0, 40, 'skull flood rate (/min)'], crownMetal: [0, 5, 'crown metal: 0 gold 1 silver 2 copper 3 rose 4 obsidian 5 palette'], crownPeaks: [3, 7, 'crown points'],
